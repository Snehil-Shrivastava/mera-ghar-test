      ...
      <div className="py-20 w-[90%] max-w-480 mx-auto relative">
        ...
        <div className="pt-8 font-openSans flex flex-col gap-8 w-150 text-neutral-700">
          ...
          <p>
            ...
            nostalgia. Every home is built with a dream and deep involvement for
            the comfort and convenience of the loved ones who live in it and
            share life together. At <b className="font-bold">Mera Ghar</b>, we
            craft precision-based, customised home interior solutions, including{" "}
